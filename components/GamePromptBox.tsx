...
// ============================================
// UPGRADED PROMPT BOX COMPONENT
// Just drop this into your existing page to replace the old prompt box
// ============================================
...
// ============================================
// MAIN PROMPT BOX COMPONENT - USE THIS
// ============================================
          ...
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between pt-2">
              ...
              <button 
                ...
                className={`group relative flex items-center gap-3 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 overflow-hidden ${isGenerating || !prompt.trim() ? 'bg-gray-700 cursor-not-allowed opacity-50' : 'bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 hover:shadow-lg hover:shadow-purple-500/25 hover:scale-105'}`}
              >
      ...
      {showPreview && game && (
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4" onClick={() => setShowPreview(false)}>
          <div 
            ...
            style={{ fontFamily: 'Oxanium, sans-serif', animation: 'slideUp 0.3s ease-out' }}
          >
