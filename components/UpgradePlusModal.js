	...
	return (
		<>
			...
			<div className="rounded-lg w-[95%] md:w-[600px] lg:w-[600px] bg-[#333A44] p-10 absolute top-1/2 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2 shadow-lg border border-gray-600">
				<h2 className="text-2xl font-semibold text-gray-200 mb-6 text-center">Buy Packages</h2>
				<div className="md:flex lg:flex md:justify-between lg:justify-between md:items-start lg:items-start">
					<div className="w-full flex flex-col items-center justify-center">
						...
						<form action="/api/subscriptions/create-checkout-session" method="POST">
							...
							<button className="block md:hidden lg:hidden bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-md text-md font-semibold transition duration-300 ease-in-out w-full shadow-md">
								Buy for $0.99
							</button>
						</form>
					</div>
