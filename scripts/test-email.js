...
transporter.verify(function(error, success) {
  if (error) {
    ...
    console.log('2. Make sure you\'ve generated an App Password if using Gmail with 2FA');
    console.log('3. Check if your Gmail account allows less secure apps (if not using App Password)');
    console.log('4. Verify that your EMAIL_USER matches the email used to generate the App Password');
  } else {
