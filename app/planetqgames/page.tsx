      ...
      <div className="relative z-10 w-full max-w-5xl px-4 py-8 sm:py-12">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            {/* Video 1 - 3D Open World */}
            <div className="relative cursor-pointer rounded-2xl overflow-hidden transition-all duration-500 group ring-2 ring-offset-2 ring-offset-gray-900 ring-emerald-500">
              <div className="absolute -inset-1 bg-emerald-500 rounded-2xl blur-lg opacity-40 group-hover:opacity-30 transition-opacity"></div>
              <div className="relative bg-gray-900/90 rounded-2xl overflow-hidden border border-gray-700/50">
                <div className="aspect-video relative overflow-hidden bg-gray-800 flex items-center justify-center">
                  <span className="text-gray-500 text-sm">[3D Open World Video]</span>
                  <div className="absolute top-3 right-3 w-8 h-8 rounded-full bg-gradient-to-r from-emerald-500 to-cyan-500 flex items-center justify-center">
                ...
                <div className="p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-lg font-bold text-white">3D Open World</h3>
                  </div>
                  <p className="text-sm text-gray-400">Explore vast landscapes and endless possibilities</p>
                </div>
              </div>
            </div>

            {/* Video 2 - Shooter Game */}
            <div className="relative cursor-pointer rounded-2xl overflow-hidden transition-all duration-500 group opacity-70 hover:opacity-100">
              <div className="absolute -inset-1 bg-red-500 rounded-2xl blur-lg opacity-0 group-hover:opacity-30 transition-opacity"></div>
              <div className="relative bg-gray-900/90 rounded-2xl overflow-hidden border border-gray-700/50">
                <div className="aspect-video relative overflow-hidden bg-gray-800 flex items-center justify-center">
                  <span className="text-gray-500 text-sm">[Shooter Game Video]</span>
                  <div className="absolute top-3 right-3 w-8 h-8 rounded-full bg-gradient-to-r from-red-500 to-orange-500 flex items-center justify-center">
                    <Play className="w-4 h-4 text-white fill-white" />
                  </div>
                </div>
                <div className="p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-lg font-bold text-white">Shooter Game</h3>
                  </div>
                  <p className="text-sm text-gray-400">Fast-paced action and intense combat</p>
                </div>
              </div>
            </div>
            ...
            {/* Video 3 - Racing Game */}
            <div className="relative cursor-pointer rounded-2xl overflow-hidden transition-all duration-500 group opacity-70 hover:opacity-100">
              <div className="absolute -inset-1 bg-blue-500 rounded-2xl blur-lg opacity-0 group-hover:opacity-30 transition-opacity"></div>
              <div className="relative bg-gray-900/90 rounded-2xl overflow-hidden border border-gray-700/50">
                <div className="aspect-video relative overflow-hidden bg-gray-800 flex items-center justify-center">
                  <span className="text-gray-500 text-sm">[Racing Game Video]</span>
                ...
                <div className="p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-lg font-bold text-white">Racing Game</h3>
                  </div>
                  <p className="text-sm text-gray-400">High-speed thrills and competitive racing</p>
                </div>
              </div>
            </div>
          </div>
