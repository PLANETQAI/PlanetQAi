...
import PlanetQProductionsText from "@/components/PlanetQProductionsText";
  ...
  return (
    <div className="overflow-y-scroll flex flex-col justify-center items-center bg-[#050816] top-0 relative z-10 p-4 sm:p-8 md:p-12 lg:p-20 min-h-screen h-full">
      ...
      <div className="relative z-10 w-full max-w-4xl px-2">
        ...
        <div className="relative w-[70vw] h-[70vw] max-w-[420px] max-h-[420px] mx-auto rounded-full overflow-hidden border-4 border-purple-400/30 shadow-[0_0_50px_rgba(167,139,250,0.3)]">
          <video
            ref={videoRef}
